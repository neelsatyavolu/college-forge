...
const GITHUB = "https://github.com/neelsatyavolu/college-forge";
const GITHUB_MARK =
      ...
      <div className="lp">
        <header className="lp-nav">
          ...
          <nav aria-label="Main">
            ...
            <a href={GITHUB} className="lp-nav__github" aria-label="College Forge on GitHub">
              <svg viewBox="0 0 16 16" width="16" height="16" aria-hidden="true" fill="currentColor">
                <path d={GITHUB_MARK} />
              </svg>
              <span>GitHub</span>
            </a>
            <a href={HUB} className="lp-nav__cta">Open <span className="lp-nav__your">your </span>workspace</a>
          </nav>
        </header>
